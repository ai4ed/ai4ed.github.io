...
Bio: Dr. Maciej Pankiewicz is a Senior Research Investigator at the Penn Center for Learning Analytics and a Visiting Assistant Professor in the Education, Culture, and Society Division at the University of Pennsylvania. He earned his Ph.D. (Dr.-Ing.) from the University of Bonn in 2011 and an M.Sc. in Computer Science and Econometrics from the Warsaw University of Life Sciences in 2006. Dr. Pankiewicz’s research focuses on educational data mining, learning analytics, and learning engineering. He has extensive experience as a software developer, data analyst, and researcher, with technical expertise in software development, data management, and predictive modeling using technologies such as Python, SQL, and R. At the Penn Center for Learning Analytics, he leads projects like JeepyTA, a virtual teaching assistant powered by large language models designed to enhance student and instructor experiences. Dr. Pankiewicz has co-authored numerous publications in top journals and conferences, including works on automating feedback on programming assignments and evaluating task difficulty in automated computer programming assessment.
...
Bio: Dr. Jill Burstein is a Principal Assessment Scientist at Duolingo, leading validity and efficacy research for the Duolingo English Test. She earned her Ph.D. in Linguistics from the City University of New York Graduate Center. Her research interests include artificial intelligence, natural language processing, and educational technology. Dr. Burstein has co-authored numerous publications in top journals and conferences, such as “Automated essay scoring for nonnative English speakers.” She has also contributed to the development of automated writing evaluation systems.
...
* Jing Hao Lim, Mohamed Raasith Mohamed Sirajudeen, Justin Kan, Pranav Tushar, Bowen Zhang, Yin Yin Loo, Indriyati Atmosukarto, Donny Soh and Ian McLoughlin. Integrating AI for Mother Tongue Language Proficiency: A Modular Approach. [Paper Link](https://drive.google.com/file/d/1OEV2gEz09kHfb282sk0ml33EIYehZntb/view?usp=sharing)
