---
layout: post
title:  IJCAI2023 Multimodal Reasoning - Techniques, Applications, and Challenges
...
One day workshop. Program includes invited talks, presentations, discussion, final panel discussion, and interactive sessions.


## Proposed Schedule

* 08:30 - 08:40 Welcome remarks
* 08:40 - 09:00 Overview of the workshop
...
* **June 20, 2023**: Workshop paper submission due AOE
* **July 04, 2023**: Notifications of acceptance
* **August 03, 2023**: Deadline of the camera-ready final paper submission
* **August 19-25, 2023**: Workshop Date (The workshop date will be communicated when the conference program is finalized.)
